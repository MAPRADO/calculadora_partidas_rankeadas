// Load and call the prompt-sync module to use the function in Node.js
...
do {
    victories = prompt('Digite o número de vitórias: ');
} while (victories <= 0 || victories > 150);

console.log("Victories: " + victories);

do {
    losses = prompt('Digite o número de derrotas: ');
